...
public class JedisClient {
	...
	public JedisClient(JedisPoolConfig poolConfig, String host, Integer port, Integer timeout, String password, Integer database) {
	...
	public void del(Set<String> keySet){
		...
		Jedis jedis = getJedis();
		jedis.del(keySet.toArray(new String[]{}));
		returnJedis(jedis);
	}
